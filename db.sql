...
BEGIN
  ...
  ELSE
  BEGIN
    TMP = GEN_ID(GEN_DOKUMENTY_ID, 0);
    IF (TMP < NEW.ID) THEN
      TMP = GEN_ID(GEN_DOKUMENTY_ID, NEW.ID-TMP);
  END
END^
SET TERM ; ^
SET TERM ^ ;
...
BEGIN
  ...
  ELSE
  BEGIN
    TMP = GEN_ID(GEN_DOK_DZIALKI_ID, 0);
    IF (TMP < NEW.ID) THEN
      TMP = GEN_ID(GEN_DOK_DZIALKI_ID, NEW.ID-TMP);
  END
END^
SET TERM ; ^
SET TERM ^ ;
...
BEGIN
  ...
  ELSE
  BEGIN
    TMP = GEN_ID(GEN_DOK_OSOBY_ID, 0);
    IF (TMP < NEW.ID) THEN
      TMP = GEN_ID(GEN_DOK_OSOBY_ID, NEW.ID-TMP);
  END
END^
SET TERM ; ^
SET TERM ^ ;
...
BEGIN
  ...
  ELSE
  BEGIN
    TMP = GEN_ID(GEN_DOK_PLIKI_ID, 0);
    IF (TMP < NEW.ID) THEN
      TMP = GEN_ID(GEN_DOK_PLIKI_ID, NEW.ID-TMP);
  END
END^
SET TERM ; ^
SET TERM ^ ;
...
BEGIN
  ...
  ELSE
  BEGIN
    TMP = GEN_ID(GEN_DZIALKI_ID, 0);
    IF (TMP < NEW.ID) THEN
      TMP = GEN_ID(GEN_DZIALKI_ID, NEW.ID-TMP);
  END
END^
SET TERM ; ^
SET TERM ^ ;
...
BEGIN
  ...
  ELSE
  BEGIN
    TMP = GEN_ID(GEN_GMINY_ID, 0);
    IF (TMP < NEW.ID) THEN
      TMP = GEN_ID(GEN_GMINY_ID, NEW.ID-TMP);
  END
END^
SET TERM ; ^
SET TERM ^ ;
...
BEGIN
  ...
  ELSE
  BEGIN
    TMP = GEN_ID(GEN_OBREBY_ID, 0);
    IF (TMP < NEW.ID) THEN
      TMP = GEN_ID(GEN_OBREBY_ID, NEW.ID-TMP);
  END
END^
SET TERM ; ^
SET TERM ^ ;
...
BEGIN
  ...
  ELSE
  BEGIN
    TMP = GEN_ID(GEN_OSOBY_ID, 0);
    IF (TMP < NEW.ID) THEN
      TMP = GEN_ID(GEN_OSOBY_ID, NEW.ID-TMP);
  END
END^
SET TERM ; ^
SET TERM ^ ;
...
BEGIN
  ...
  ELSE
  BEGIN
    TMP = GEN_ID(GEN_PLIKI_ID, 0);
    IF (TMP < NEW.ID) THEN
      TMP = GEN_ID(GEN_PLIKI_ID, NEW.ID-TMP);
  END
END^
SET TERM ; ^
SET TERM ^ ;
...
BEGIN
  ...
  ELSE
  BEGIN
    TMP = GEN_ID(GEN_RODZAJEDOK_ID, 0);
    IF (TMP < NEW.ID) THEN
      TMP = GEN_ID(GEN_RODZAJEDOK_ID, NEW.ID-TMP);
  END
END^
SET TERM ; ^
